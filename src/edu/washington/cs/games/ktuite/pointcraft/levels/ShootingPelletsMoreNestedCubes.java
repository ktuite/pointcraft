...
public class ShootingPelletsMoreNestedCubes extends BaseShootingPelletsLevel {

	public ShootingPelletsMoreNestedCubes(Main main) {
		super(main);
		...
		float[] cube_extent_array = { cube_extent, cube_extent * 2, cube_extent / 2f };
		int[] points_per_cube_array = { points_per_cube, points_per_cube * 2, (int) (points_per_cube * .8f)};
		int total_points = 0;
